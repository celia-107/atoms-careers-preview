 ...
 * 招聘页面非岗位数据。
 *
 * 这里的文案只作为页面演示，尤其是流程、地点和联系方式都需要在正式发布前
 * 由团队确认。把它们放在独立数据层，方便后续接入内容管理或飞书招聘时替换。
 */
...
export const CAREER_FAQS: readonly FaqItem[] = [
  {
    ...
    category: '岗位与地点',
    question: '现在有哪些岗位？',
    answer: '页面中的岗位目前是用于展示筛选和详情交互的示例数据，不代表当前真实岗位数量或开放状态。正式岗位会以岗位列表和对应的公开说明为准。',
  },
  {
    id: 'location',
    category: '岗位与地点',
    question: '工作地点和远程方式是怎样的？',
    answer: '不同岗位的地点要求可能不同，页面里的地点字段也是示例。具体办公地点、远程协作范围和到岗安排，需以目标岗位发布时的确认信息为准。',
  },
  {
    id: 'internship',
    category: '岗位与地点',
    question: '会开放实习岗位吗？',
    answer: '是否开放实习取决于具体岗位和团队安排。当前页面展示的用工类型仅用于演示筛选，不构成实习机会或名额承诺。',
  },
  {
    id: 'portfolio',
    category: '申请与作品',
